...
#ifndef _VECMSG_PUBSUBTYPES_H_
#define _VECMSG_PUBSUBTYPES_H_
...
#error Generated VecMsg is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type VecMsg defined by the user in the IDL file.
 * @ingroup VECMSG
 */
class VecMsgPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef VecMsg type;

    eProsima_user_DllExport VecMsgPubSubType();

    eProsima_user_DllExport virtual ~VecMsgPubSubType();
